...
// pub fn handle_get_many_events(_: &mut Request, _: DbPooledConnection) -> IronResult<Response> {
//     let json = {
...
// pub fn handle_post_new_event(request: &mut Request, _: DbPooledConnection) -> IronResult<Response> {
